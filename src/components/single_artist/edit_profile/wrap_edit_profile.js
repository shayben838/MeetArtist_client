...
class WrapEditProfile extends React.Component {
  ...
  onFilechange = (image) => {
    this.setState({ main_image: image });
  };
  ...
  render() {
    return (
      <div>
        ...
        {/* PERSONAL DATA */}
        {this.props.type === "personal_data_form" &&
          this.state.formStatus === "open" && (
            <EditPersonalData
              dataAPI={this.props.dataAPI}
              onchange={this.onchange}
              onChangeAutoComplit={this.onChangeAutoComplit}
              state={this.state}
        ...
        {/* MUSIC DATA */}
        {this.props.type === "music_data_form" &&
          this.state.formStatus === "open" && (
            <EditMusicData
              dataAPI={this.props.dataAPI}
              onchange={this.onchange}
