    ...
    return (
        ...
        <div className="wrap_member_description row m-0 " >
            <div className="col-12  ">
                <h3 className=" featurette-heading mt-4 mb-1    pl-3 pt-1 ml-1" style={{ textTransform: "capitalize" }}>{user.display_name}</h3>
                <p className="m-0  pl-2 pl-3  ml-1" style={{ textTransform: "capitalize" }}> {`"${user.headline}"`}</p>
                <p className="m-0 pl-2  pl-3 ml-1 lead" style={{ textTransform: "capitalize" }}>{profession}</p>
