  ...
  return (
    <div>
        ...
        <div key={index}>
          <div className='position-relative'>
            <input
              type='text'
              name={singleState}
              placeholder={arrLoopPlaceOrder[index]}
              id={singleState}
      ...
      <AutoComplit
        ...
        onchange={onchange}
        stateVal={state.country_id.value}
      ...
      {state.country_id.value && (
        <AutoComplit
          ...
          onChangeAutoComplit={onChangeAutoComplit}
          onchange={onchange}
          stateVal={state.city_id.value}
          dataArr={dataAPI.cities.filter(
            (item) => item["country_id"] === state.country_id.value
          )}
          option={"name"}
          placeholder={"City"}
          InputName={"city_id"}
